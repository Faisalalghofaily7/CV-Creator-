...
export function buildCvHtml({ form, experiences, education, courses, certifications, customSections, techSkills, softSkills, skillDetails, splitLines, splitList, lang = "ar" }) {
  ...
  // is present the group renders as a bulleted "Name — description" list.
  // Professional/soft skills NEVER have descriptions, for anyone, so that
  // group always renders as the original plain joined-list line.
