 ...
 */
export function buildCvHtml({ form, experiences, education, courses, certifications, techSkills, softSkills, splitLines, splitList, lang = "ar" }) {
  ...
  const contactHtml = inlineFields([
    ...
    form.city,
    form.linkedin,
    form.yearsOfExperience ? `${form.yearsOfExperience} ${t.yearsOfExperience}` : "",
  ]);
