...
// to the live production URL as a last resort (never throws — a
// best-effort message beats no message).
export const APP_PUBLIC_URL = process.env.APP_PUBLIC_URL || process.env.APP_URL || "https://cv-creator-iota-olive.vercel.app";
