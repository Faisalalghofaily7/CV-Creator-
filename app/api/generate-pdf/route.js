...
export async function POST(request) {
  ...
  try {
    ...
    const { form, experiences, education, projects, courses, certifications, techSkills, softSkills, lang, accessCode } = body;
    ...
    const html = buildCvHtml({ form, experiences, education, projects, courses, certifications, techSkills, softSkills, splitLines, splitList, lang });
